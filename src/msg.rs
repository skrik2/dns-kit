...
pub const MAX_DOMAIN_NAME_WIRE_OCTETS: u8 = 255;
...
pub const MAX_COMPRESSION_POINTERS: u8 = ((MAX_DOMAIN_NAME_WIRE_OCTETS as u16 + 1) / 2 - 2) as u8;
...
pub const MAX_DOMAIN_NAME_PRESENTATION_LENGTH: usize =
